...
test('LogIn component', () => {
  ...
  test('should update state when inputs change', () => {
    ...
    test.expect(getByPlaceholderText('uni@gmail.com').value).toBe('test@gmail.com')
    test.expect(getByPlaceholderText('micontraseña123').value).toBe('password123')
  })
  ...
  test('should display warning when login fails', async () => {
    ...
    await test.waitFor(() => {
      test.expect(getByText('Credenciales incorrectas. Inténtelo de nuevo')).toBeInTheDocument()
    })
  })
})
